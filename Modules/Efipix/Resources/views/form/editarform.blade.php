        ...
        @csrf
          <div class="row">
              ...
              <div class="mb-3">
                ...
                <input type="text" value="{{$data -> cpf_pagante ?? ''}}" class="form-control" name="cpf_pagante" maxlength="11">
            </div>

              <div class="mb-3">
                  <label for="" class="form-label">Nome Recebedor:</label>
                  <input type="text" value="{{$data -> nome_recebedor ?? ''}}" class="form-control" name="nome_recebedor" maxlength="200">
              </div>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" maxlength="200" value="{{$data -> chave ?? ''}}" class="form-control" name="chave" >
              </div>

              <div class="mb-3">
                <label for="" class="form-label">Valor:</label>
                <input type="text" maxlength="100" value="{{$data -> valor ?? ''}}" class="form-control" name="valor" >
              </div>
